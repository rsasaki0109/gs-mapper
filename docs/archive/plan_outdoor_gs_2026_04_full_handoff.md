# 屋外 3D Gaussian Splatting 開発計画 / 2026-04 full handoff archive

このファイルは 2026-04 セッション履歴を含む full handoff snapshot です。現行の短い handoff は [../plan_outdoor_gs.md](../plan_outdoor_gs.md) を参照してください。
